...
def load_pokec_z(dataset,sens_attr="region",predict_attr='I_am_working_in_field', path="dataset/pokec/", label_number=500,seed=20,test_idx=False):
    """Load data"""
    print('Loading {} dataset from {}'.format(dataset,path))
...
def load_pokec_n(dataset,sens_attr="region",predict_attr='I_am_working_in_field', path="dataset/pokec/", label_number=500,seed=20,test_idx=False):
    """Load data"""
    print('Loading {} dataset from {}'.format(dataset,path))
